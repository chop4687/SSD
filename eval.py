...
def get_voc_results_file_template(image_set, cls):
    ...
    filedir = os.path.join('/content/drive/My Drive/Colab Notebooks/results')
...
def do_python_eval(output_dir='output', use_07=True):
    cachedir = os.path.join('/content/drive/My Drive/Colab Notebooks/annotations_cache')
    aps = []
...
def test_net(save_folder, net, dataset, transform, top_k,
    ...
    output_dir = '/content/drive/My Drive/Colab Notebooks/ssd300_120000/val'
...
def eval_func(epoch):
    ...
    net.load_state_dict(torch.load('/content/drive/My Drive/Colab Notebooks/ssd' + str(epoch) + '.pth'))
